...
export default function GeoteknikPage() {
  ...
  async function loadFiles() {
    try {
      const data = await getProjectFiles(params.id as string, 'geoteknik');
      setFiles(data);
    } catch (error) {
    ...
    <div className="p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Geoteknik raporlarını ve analizleri yükleyin ve yönetin
        </p>
      </div>
