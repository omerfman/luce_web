...
export default function IcTasarimPage() {
  ...
  async function loadFiles() {
    try {
      const data = await getProjectFiles(params.id as string, 'ic_tasarim');
      setFiles(data);
    } catch (error) {
    ...
    <div className="p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          İç tasarım projelerini ve görsellerini yükleyin ve yönetin
        </p>
      </div>
